...
def mine_block():
    ...
    blockchain.add_transactions(sender=node_address,receiver = 'Shivam Birmole', amount = 10 )
...
def connect_node():
    ...
    resoponse = {
        'message': 'Nodes connected, total nodes are',
...
def replace_chain():
    ...
    if is_replace :
        ...
        response = {'message':"No replacement",
